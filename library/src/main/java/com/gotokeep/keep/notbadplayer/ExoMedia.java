...
import com.gotokeep.keep.notbadplayer.core.source.MediaSourceProvider;
import com.gotokeep.keep.notbadplayer.core.source.builder.HlsMediaSourceBuilder;
...
public class ExoMedia {
     ...
     * instances for use with the {@link MediaSourceProvider}s. This will
     * only be used for builders that haven't customized the {@link com.gotokeep.keep.notbadplayer.core.source.builder.MediaSourceBuilder#buildDataSourceFactory(Context, String, TransferListener)}
     * method.
     *
     * @param provider The provider to use for the {@link com.gotokeep.keep.notbadplayer.core.source.builder.MediaSourceBuilder}s
     ...
     * instances for use with the {@link com.gotokeep.keep.notbadplayer.core.source.builder.MediaSourceBuilder}s. This will
     * only be used for builders that haven't customized the {@link com.gotokeep.keep.notbadplayer.core.source.builder.MediaSourceBuilder#buildDataSourceFactory(Context, String, TransferListener)}
     * method.
     *
     * @param provider The provider to use for the {@link com.gotokeep.keep.notbadplayer.core.source.builder.MediaSourceBuilder}s
     ...
     * used in the {@link com.gotokeep.keep.notbadplayer.widgets.VideoView} and {@link AudioPlayer}. This allows the
